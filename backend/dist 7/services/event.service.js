...
exports.archiveExpiredEventRecords = archiveExpiredEventRecords;
...
function archiveExpiredEventRecords() {
    return __awaiter(this, arguments, void 0, function* (referenceTime = new Date()) {
        const result = yield eventModel_1.EventModel.updateMany({
            isHidden: { $ne: true },
