...
function getAllEvents(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield (0, event_service_1.findEvents)((0, controllerUtils_1.visibleFilter)(req));
...
function getEventById(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield (0, event_service_1.findEventById)((0, controllerUtils_1.getRouteParam)(req.params.id), (0, controllerUtils_1.visibleFilter)(req));
            if (!result) {
...
function getEventByQuery(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = yield (0, event_service_1.queryEventsByField)(key, value, (0, controllerUtils_1.visibleFilter)(req));
            res.status(200).json(result);
        }
        catch (err) {
...
function getEventByGenericQuery(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield (0, event_service_1.queryEvents)(req.body, (0, controllerUtils_1.visibleFilter)(req));
            res.status(200).json(result);
        }
        catch (err) {
