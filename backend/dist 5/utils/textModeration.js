...
exports.DISALLOWED_LANGUAGE_MESSAGE = void 0;
exports.normalizeForModeration = normalizeForModeration;
exports.containsDisallowedLanguage = containsDisallowedLanguage;
exports.assertAllowedLanguage = assertAllowedLanguage;
const GAP = "[^a-z0-9]*";
exports.DISALLOWED_LANGUAGE_MESSAGE = "Teksten indeholder stødende eller diskriminerende sprog.";
...
function normalizeForModeration(value) {
    return Array.from(value
        ...
        .replace(/å/g, "a")
        .toLowerCase())
        .map((character) => { var _a; return (_a = LEET_REPLACEMENTS[character]) !== null && _a !== void 0 ? _a : character; })
        .join("");
}
function containsDisallowedLanguage(value) {
    const normalized = normalizeForModeration(value);
    return DISALLOWED_LANGUAGE_PATTERNS.some((pattern) => pattern.test(normalized));
}
function assertAllowedLanguage(value) {
    if (!containsDisallowedLanguage(value)) {
        return;
    }
    const error = new Error(exports.DISALLOWED_LANGUAGE_MESSAGE);
